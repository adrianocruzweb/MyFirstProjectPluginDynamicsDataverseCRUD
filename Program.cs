...
namespace MyFirstProjectPlugin
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            RemoveEntity(crmService, Guid.Parse("88cea450-cb0c-ea11-a813-000d3a1b1223"));
        ...
        static void Create(CrmServiceClient crmServiceClient)
        {
            for(int i = 0; i < 2; i++)
            {
        ...
        static void UpdateEntity(CrmServiceClient crmService, Guid id)
        {
            try
            {
        ...
        static void RemoveEntity(CrmServiceClient crmService, Guid guidAccount)
        {
            try
            {
